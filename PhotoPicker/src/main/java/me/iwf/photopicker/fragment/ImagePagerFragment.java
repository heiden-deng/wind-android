...
public class ImagePagerFragment extends Fragment {
    ...
    public final static String ARG_IS_AVTOR = "ARG_IS_AVTOR";
    ...
    public static ImagePagerFragment newInstance(List<String> paths, int currentItem, boolean isCicle) {
        ...
        args.putInt(ARG_CURRENT_ITEM, currentItem);
        args.putBoolean(ARG_HAS_ANIM, false);
        args.putBoolean(ARG_IS_AVTOR, isCicle);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new PhotoPagerAdapter(Glide.with(this), paths, bundle.getBoolean(ARG_IS_AVTOR));
    }
