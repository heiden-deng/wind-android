...
public class PhotoPicker {
  ...
  public final static String EXTRA_PREVIEW_MODE = "extra_preview_mode";
  public final static String EXTRA_PREVIEW_PHOTOS = "extra_preview_photo";

  /**
   * 单张图片预览模式
   */
  public final static String EXTRA_PREVIEW_ONE_IMG = "EXTRA_PREVIEW_ONE_IMG";
  public final static String EXTRA_PREVIEW_ONE_IMG_PATH = "EXTRA_PREVIEW_ONE_IMG_PATH";

  public final static String EXTRA_PREVIEW_ONE_AVTOR = "EXTRA_PREVIEW_ONE_AVTOR";
  /**
   * 直接打开相机
   */
  public final static String EXTRA_TAKE_PHOTO = "EXTRA_TAKE_PHOTO";
  ...
  public static class PhotoPickerBuilder {
    ...
    public PhotoPickerBuilder setTakePhoto(boolean takePhoto) {
      mPickerOptionsBundle.putBoolean(EXTRA_TAKE_PHOTO, takePhoto);
      return this;
    }

    public PhotoPickerBuilder setPreviewMode(boolean previewEnabled) {
      mPickerOptionsBundle.putBoolean(EXTRA_PREVIEW_MODE, previewEnabled);
      return this;
    }

    public PhotoPickerBuilder setPreviewPhotoPaths(ArrayList<String> photoPaths) {
      mPickerOptionsBundle.putStringArrayList(EXTRA_PREVIEW_PHOTOS, photoPaths);
      return this;
    }

    public PhotoPickerBuilder setPreviewOneImg(String img) {
      mPickerOptionsBundle.putBoolean(EXTRA_PREVIEW_ONE_IMG, true);
      mPickerOptionsBundle.putString(EXTRA_PREVIEW_ONE_IMG_PATH, img);
      return this;
    }

    public PhotoPickerBuilder setPreviewOneAvtor(String img) {
      mPickerOptionsBundle.putBoolean(EXTRA_PREVIEW_ONE_IMG, true);
      mPickerOptionsBundle.putBoolean(EXTRA_PREVIEW_ONE_AVTOR, true);
      mPickerOptionsBundle.putString(EXTRA_PREVIEW_ONE_IMG_PATH, img);
      return this;
    }
  }
