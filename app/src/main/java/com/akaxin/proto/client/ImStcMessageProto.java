...
public final class ImStcMessageProto {
  ...
  public  static final class ImStcMessageRequest extends
     ...
     * <code>repeated .client.MsgWithPointer list = 1;</code>
     */
    private void addList(com.akaxin.proto.client.ImStcMessageProto.MsgWithPointer value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureListIsMutable();
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.client.ImStcMessageProto.ImStcMessageRequest();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          com.akaxin.proto.client.ImStcMessageProto.ImStcMessageRequest other = (com.akaxin.proto.client.ImStcMessageProto.ImStcMessageRequest) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.client.ImStcMessageProto.ImStcMessageRequest.class) {
              if (PARSER == null) {
  ...
  public  static final class MsgWithPointer extends
     ...
     * <code>optional .core.MsgStatus status = 3;</code>
     */
    private void setStatus(com.akaxin.proto.core.CoreProto.MsgStatus value) {
      if (value == null) {
        throw new NullPointerException();
      }
      status_ = value;
     ...
     * <code>optional .core.MsgStatus status = 3;</code>
     */
    private void mergeStatus(com.akaxin.proto.core.CoreProto.MsgStatus value) {
      if (status_ != null &&
          status_ != com.akaxin.proto.core.CoreProto.MsgStatus.getDefaultInstance()) {
        status_ =
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.client.ImStcMessageProto.MsgWithPointer();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.client.ImStcMessageProto.MsgWithPointer other = (com.akaxin.proto.client.ImStcMessageProto.MsgWithPointer) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.client.ImStcMessageProto.MsgWithPointer.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class ImStcMessageResponse extends
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.client.ImStcMessageProto.ImStcMessageResponse();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.client.ImStcMessageProto.ImStcMessageResponse other = (com.akaxin.proto.client.ImStcMessageProto.ImStcMessageResponse) arg1;
          if (visitor == MergeFromVisitor
              .INSTANCE) {
          }
          return this;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.client.ImStcMessageProto.ImStcMessageResponse.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
