...
public final class GroupProto {
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.core.GroupProto.GroupProfile();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          com.akaxin.proto.core.GroupProto.GroupProfile other = (com.akaxin.proto.core.GroupProto.GroupProfile) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.core.GroupProto.GroupProfile.class) {
              if (PARSER == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.core.GroupProto.SimpleGroupProfile();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.core.GroupProto.SimpleGroupProfile other = (com.akaxin.proto.core.GroupProto.SimpleGroupProfile) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.core.GroupProto.SimpleGroupProfile.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class GroupMemberProfile extends
    ...
    public com.akaxin.proto.core.GroupProto.GroupMemberRole getRole() {
      com.akaxin.proto.core.GroupProto.GroupMemberRole result = com.akaxin.proto.core.GroupProto.GroupMemberRole.forNumber(role_);
     ...
     * <code>optional .core.GroupMemberRole role = 1;</code>
     */
    private void setRole(com.akaxin.proto.core.GroupProto.GroupMemberRole value) {
      if (value == null) {
        throw new NullPointerException();
      }
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.core.GroupProto.GroupMemberProfile();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.core.GroupProto.GroupMemberProfile other = (com.akaxin.proto.core.GroupProto.GroupMemberProfile) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.core.GroupProto.GroupMemberProfile.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
