...
public final class PushProto {
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.core.PushProto.Notification();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          com.akaxin.proto.core.PushProto.Notification other = (com.akaxin.proto.core.PushProto.Notification) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.core.PushProto.Notification.class) {
              if (PARSER == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.core.PushProto.Notifications();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.core.PushProto.Notifications other = (com.akaxin.proto.core.PushProto.Notifications) arg1;
          siteServer_ = visitor.visitString(!siteServer_.isEmpty(), siteServer_,
              !other.siteServer_.isEmpty(), other.siteServer_);
          pushTitle_ = visitor.visitString(!pushTitle_.isEmpty(), pushTitle_,
              !other.pushTitle_.isEmpty(), other.pushTitle_);
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.core.PushProto.Notifications.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  checkByteStringIsUtf8(value);
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.core.PushProto.PushFromUser();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.core.PushProto.PushFromUser other = (com.akaxin.proto.core.PushProto.PushFromUser) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.core.PushProto.PushFromUser.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  checkByteStringIsUtf8(value);
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.core.PushProto.PushToUser();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.core.PushProto.PushToUser other = (com.akaxin.proto.core.PushProto.PushToUser) arg1;
          globalUserId_ = visitor.visitString(!globalUserId_.isEmpty(), globalUserId_,
              !other.globalUserId_.isEmpty(), other.globalUserId_);
          userToken_ = visitor.visitString(!userToken_.isEmpty(), userToken_,
              !other.userToken_.isEmpty(), other.userToken_);
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.core.PushProto.PushToUser.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
