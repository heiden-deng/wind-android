...
public final class DeviceProto {
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.core.DeviceProto.DeviceProfile();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          com.akaxin.proto.core.DeviceProto.DeviceProfile other = (com.akaxin.proto.core.DeviceProto.DeviceProfile) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.core.DeviceProto.DeviceProfile.class) {
              if (PARSER == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.core.DeviceProto.SimpleDeviceProfile();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.core.DeviceProto.SimpleDeviceProfile other = (com.akaxin.proto.core.DeviceProto.SimpleDeviceProfile) arg1;
          deviceId_ = visitor.visitString(!deviceId_.isEmpty(), deviceId_,
              !other.deviceId_.isEmpty(), other.deviceId_);
          deviceName_ = visitor.visitString(!deviceName_.isEmpty(), deviceName_,
              !other.deviceName_.isEmpty(), other.deviceName_);
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.core.DeviceProto.SimpleDeviceProfile.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
