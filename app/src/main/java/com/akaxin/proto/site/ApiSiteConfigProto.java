...
public final class ApiSiteConfigProto {
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.site.ApiSiteConfigProto.ApiSiteConfigRequest();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          com.akaxin.proto.site.ApiSiteConfigProto.ApiSiteConfigRequest other = (com.akaxin.proto.site.ApiSiteConfigProto.ApiSiteConfigRequest) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.site.ApiSiteConfigProto.ApiSiteConfigRequest.class) {
              if (PARSER == null) {
  ...
  public  static final class ApiSiteConfigResponse extends
     ...
     * <code>optional .core.SiteConfig site_config = 1;</code>
     */
    private void setSiteConfig(com.akaxin.proto.core.ConfigProto.SiteConfig value) {
      if (value == null) {
     ...
     * <code>optional .core.SiteConfig site_config = 1;</code>
     */
    private void mergeSiteConfig(com.akaxin.proto.core.ConfigProto.SiteConfig value) {
      if (siteConfig_ != null &&
          siteConfig_ != com.akaxin.proto.core.ConfigProto.SiteConfig.getDefaultInstance()) {
        siteConfig_ =
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.site.ApiSiteConfigProto.ApiSiteConfigResponse();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.site.ApiSiteConfigProto.ApiSiteConfigResponse other = (com.akaxin.proto.site.ApiSiteConfigProto.ApiSiteConfigResponse) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.site.ApiSiteConfigProto.ApiSiteConfigResponse.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
