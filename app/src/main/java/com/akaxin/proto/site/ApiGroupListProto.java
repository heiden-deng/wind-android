...
public final class ApiGroupListProto {
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.site.ApiGroupListProto.ApiGroupListRequest();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          com.akaxin.proto.site.ApiGroupListProto.ApiGroupListRequest other = (com.akaxin.proto.site.ApiGroupListProto.ApiGroupListRequest) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.site.ApiGroupListProto.ApiGroupListRequest.class) {
              if (PARSER == null) {
  ...
  public  static final class ApiGroupListResponse extends
    ...
    private com.google.protobuf.Internal.ProtobufList<com.akaxin.proto.core.GroupProto.SimpleGroupProfile> list_;
    /**
     * <pre>
     *用户的群列表
     * </pre>
     ...
     * <code>repeated .core.SimpleGroupProfile list = 1;</code>
     */
    private void addList(com.akaxin.proto.core.GroupProto.SimpleGroupProfile value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureListIsMutable();
    ...
    private void addAllList(
        Iterable<? extends com.akaxin.proto.core.GroupProto.SimpleGroupProfile> values) {
      ensureListIsMutable();
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.akaxin.proto.site.ApiGroupListProto.ApiGroupListResponse();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          com.akaxin.proto.site.ApiGroupListProto.ApiGroupListResponse other = (com.akaxin.proto.site.ApiGroupListProto.ApiGroupListResponse) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.akaxin.proto.site.ApiGroupListProto.ApiGroupListResponse.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
