...
//    }
  ...
  public static final class Builder {
    private static final int MAX_BYTES = 10 * 1024 * 1024; // 10M (500K averages to a 4000 lines per file)
    ...
    public CsvFormatStrategy build() {
      ...
      if (logStrategy == null) {
        ...
        String folder = diskPath + File.separatorChar + "wuer" + File.separatorChar + "log";
