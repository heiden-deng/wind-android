...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView(){
        ...
        //add margin by yichao
        LinearLayout.LayoutParams progressConlp =
                new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        progressConlp.setMargins(0,
                (int)getResources().getDimension(R.dimen.progresscon_margin),
                0,
                (int)getResources().getDimension(R.dimen.progresscon_margin));

        progressCon.setLayoutParams(progressConlp);
