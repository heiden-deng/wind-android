...
public final class ConfigProto {
  ...
  public interface SiteConfigOrBuilder extends
     ...
     * <code>optional .core.RealNameConfig real_name_config = 7;</code>
     */
    RealNameConfig getRealNameConfig();
     ...
     * <code>optional .core.SiteStatusConfig site_status_config = 9;</code>
     */
    SiteStatusConfig getSiteStatusConfig();
     ...
     * <code>optional .core.U2EncryptionConfig u2_encryption_config = 11;</code>
     */
    U2EncryptionConfig getU2EncryptionConfig();
     ...
     * <code>optional .core.InviteCodeConfig invite_code_config = 12;</code>
     */
    InviteCodeConfig getInviteCodeConfig();
  }
  /**
   * <pre>
   * 站点配置信息
  ...
  checkByteStringIsUtf8(value);
    ...
    public RealNameConfig getRealNameConfig() {
      RealNameConfig result = RealNameConfig.forNumber(realNameConfig_);
      return result == null ? RealNameConfig.UNRECOGNIZED : result;
    }
    /**
     * <pre>
     *站点是否需要实名
     ...
     * <code>optional .core.RealNameConfig real_name_config = 7;</code>
     */
    private void setRealNameConfig(RealNameConfig value) {
      if (value == null) {
        throw new NullPointerException();
      }
  ...
  checkByteStringIsUtf8(value);
     ...
     * <code>optional .core.SiteStatusConfig site_status_config = 9;</code>
     */
    public SiteStatusConfig getSiteStatusConfig() {
      SiteStatusConfig result = SiteStatusConfig.forNumber(siteStatusConfig_);
      return result == null ? SiteStatusConfig.UNRECOGNIZED : result;
    }
    /**
     * <pre>
     *站点状态
     ...
     * <code>optional .core.SiteStatusConfig site_status_config = 9;</code>
     */
    private void setSiteStatusConfig(SiteStatusConfig value) {
      if (value == null) {
        throw new NullPointerException();
      }
  ...
  checkByteStringIsUtf8(value);
     ...
     * <code>optional .core.U2EncryptionConfig u2_encryption_config = 11;</code>
     */
    public U2EncryptionConfig getU2EncryptionConfig() {
      U2EncryptionConfig result = U2EncryptionConfig.forNumber(u2EncryptionConfig_);
      return result == null ? U2EncryptionConfig.UNRECOGNIZED : result;
    }
    /**
     * <pre>
     *二人消息加密状态
     ...
     * <code>optional .core.U2EncryptionConfig u2_encryption_config = 11;</code>
     */
    private void setU2EncryptionConfig(U2EncryptionConfig value) {
      if (value == null) {
        throw new NullPointerException();
      }
     ...
     * <code>optional .core.InviteCodeConfig invite_code_config = 12;</code>
     */
    public InviteCodeConfig getInviteCodeConfig() {
      InviteCodeConfig result = InviteCodeConfig.forNumber(inviteCodeConfig_);
      return result == null ? InviteCodeConfig.UNRECOGNIZED : result;
    }
    /**
     * <pre>
     *站点注册是否需要邀请码
     ...
     * <code>optional .core.InviteCodeConfig invite_code_config = 12;</code>
     */
    private void setInviteCodeConfig(InviteCodeConfig value) {
      if (value == null) {
        throw new NullPointerException();
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (realNameConfig_ != RealNameConfig.REALNAME_NO.getNumber()) {
        output.writeEnum(7, realNameConfig_);
      }
      if (!picSize_.isEmpty()) {
        output.writeString(8, getPicSize());
      }
      if (siteStatusConfig_ != SiteStatusConfig.CLOSE.getNumber()) {
        output.writeEnum(9, siteStatusConfig_);
      }
      if (!siteStatusInfo_.isEmpty()) {
        output.writeString(10, getSiteStatusInfo());
      }
      if (u2EncryptionConfig_ != U2EncryptionConfig.U2_CLOSE.getNumber()) {
        output.writeEnum(11, u2EncryptionConfig_);
      }
      if (inviteCodeConfig_ != InviteCodeConfig.UIC_NO.getNumber()) {
    ...
    public static SiteConfig parseFrom(
    ...
    public static SiteConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static SiteConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
    ...
    public static SiteConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static SiteConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(SiteConfig prototype) {
    ...
    public static final class Builder extends
        ...
        SiteConfigOrBuilder {
      // Construct using com.windchat.proto.core.ConfigProto.SiteConfig.newBuilder()
      private Builder() {
       ...
       * <code>optional .core.RealNameConfig real_name_config = 7;</code>
       */
      public Builder setRealNameConfig(RealNameConfig value) {
        copyOnWrite();
       ...
       * <code>optional .core.SiteStatusConfig site_status_config = 9;</code>
       */
      public Builder setSiteStatusConfig(SiteStatusConfig value) {
        copyOnWrite();
       ...
       * <code>optional .core.U2EncryptionConfig u2_encryption_config = 11;</code>
       */
      public Builder setU2EncryptionConfig(U2EncryptionConfig value) {
        copyOnWrite();
       ...
       * <code>optional .core.InviteCodeConfig invite_code_config = 12;</code>
       */
      public Builder setInviteCodeConfig(InviteCodeConfig value) {
        copyOnWrite();
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          ...
          SiteConfig other = (SiteConfig) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (SiteConfig.class) {
              if (PARSER == null) {
    ...
    private static final SiteConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SiteConfig();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static SiteConfig getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public  static final class SiteBackConfig extends
    ...
    public static SiteBackConfig parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    ...
    public static SiteBackConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static SiteBackConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, input);
    }
    ...
    public static SiteBackConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static SiteBackConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
    ...
    public static Builder newBuilder(SiteBackConfig prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends
        ...
        SiteBackConfigOrBuilder {
      // Construct using com.windchat.proto.core.ConfigProto.SiteBackConfig.newBuilder()
      private Builder() {
        super(DEFAULT_INSTANCE);
      }
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          SiteBackConfig other = (SiteBackConfig) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (SiteBackConfig.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
    ...
    private static final SiteBackConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new SiteBackConfig();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static SiteBackConfig getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
