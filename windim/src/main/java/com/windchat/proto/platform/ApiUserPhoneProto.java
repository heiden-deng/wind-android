...
public final class ApiUserPhoneProto {
  ...
  public  static final class ApiUserPhoneRequest extends
    ...
    public static ApiUserPhoneRequest parseFrom(
    ...
    public static ApiUserPhoneRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static ApiUserPhoneRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
    ...
    public static ApiUserPhoneRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static ApiUserPhoneRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(ApiUserPhoneRequest prototype) {
    ...
    public static final class Builder extends
        ...
        ApiUserPhoneRequestOrBuilder {
      // Construct using com.windchat.proto.platform.ApiUserPhoneProto.ApiUserPhoneRequest.newBuilder()
      private Builder() {
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new ApiUserPhoneRequest();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          ApiUserPhoneRequest other = (ApiUserPhoneRequest) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (ApiUserPhoneRequest.class) {
              if (PARSER == null) {
    ...
    private static final ApiUserPhoneRequest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ApiUserPhoneRequest();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static ApiUserPhoneRequest getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  checkByteStringIsUtf8(value);
    ...
    public static ApiUserPhoneResponse parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    ...
    public static ApiUserPhoneResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static ApiUserPhoneResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, input);
    }
    ...
    public static ApiUserPhoneResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static ApiUserPhoneResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
    ...
    public static Builder newBuilder(ApiUserPhoneResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends
        ...
        ApiUserPhoneResponseOrBuilder {
      // Construct using com.windchat.proto.platform.ApiUserPhoneProto.ApiUserPhoneResponse.newBuilder()
      private Builder() {
        super(DEFAULT_INSTANCE);
      }
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new ApiUserPhoneResponse();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          ApiUserPhoneResponse other = (ApiUserPhoneResponse) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (ApiUserPhoneResponse.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
    ...
    private static final ApiUserPhoneResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ApiUserPhoneResponse();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static ApiUserPhoneResponse getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
