...
public final class ApiPhoneApplyTokenProto {
  ...
  checkByteStringIsUtf8(value);
    ...
    public static ApiPhoneApplyTokenRequest parseFrom(
    ...
    public static ApiPhoneApplyTokenRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static ApiPhoneApplyTokenRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
    ...
    public static ApiPhoneApplyTokenRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static ApiPhoneApplyTokenRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(ApiPhoneApplyTokenRequest prototype) {
    ...
    public static final class Builder extends
        ...
        ApiPhoneApplyTokenRequestOrBuilder {
      // Construct using com.windchat.proto.platform.ApiPhoneApplyTokenProto.ApiPhoneApplyTokenRequest.newBuilder()
      private Builder() {
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new ApiPhoneApplyTokenRequest();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          ApiPhoneApplyTokenRequest other = (ApiPhoneApplyTokenRequest) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (ApiPhoneApplyTokenRequest.class) {
              if (PARSER == null) {
    ...
    private static final ApiPhoneApplyTokenRequest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ApiPhoneApplyTokenRequest();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static ApiPhoneApplyTokenRequest getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  checkByteStringIsUtf8(value);
    ...
    public static ApiPhoneApplyTokenResponse parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    ...
    public static ApiPhoneApplyTokenResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static ApiPhoneApplyTokenResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, input);
    }
    ...
    public static ApiPhoneApplyTokenResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static ApiPhoneApplyTokenResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
    ...
    public static Builder newBuilder(ApiPhoneApplyTokenResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends
        ...
        ApiPhoneApplyTokenResponseOrBuilder {
      // Construct using com.windchat.proto.platform.ApiPhoneApplyTokenProto.ApiPhoneApplyTokenResponse.newBuilder()
      private Builder() {
        super(DEFAULT_INSTANCE);
      }
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new ApiPhoneApplyTokenResponse();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          ApiPhoneApplyTokenResponse other = (ApiPhoneApplyTokenResponse) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (ApiPhoneApplyTokenResponse.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
    ...
    private static final ApiPhoneApplyTokenResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ApiPhoneApplyTokenResponse();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static ApiPhoneApplyTokenResponse getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
