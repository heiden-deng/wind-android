...
// source: server/api_device_list.proto
...
public final class ApiDeviceListProto {
  ...
  checkByteStringIsUtf8(value);
    ...
    public static DeviceListInfoRequest parseFrom(
    ...
    public static DeviceListInfoRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static DeviceListInfoRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
    ...
    public static DeviceListInfoRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static DeviceListInfoRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(DeviceListInfoRequest prototype) {
    ...
    public static final class Builder extends
        ...
        DeviceListInfoRequestOrBuilder {
      // Construct using com.windchat.proto.server.ApiDeviceListProto.DeviceListInfoRequest.newBuilder()
      private Builder() {
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new DeviceListInfoRequest();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          DeviceListInfoRequest other = (DeviceListInfoRequest) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (DeviceListInfoRequest.class) {
              if (PARSER == null) {
    ...
    private static final DeviceListInfoRequest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DeviceListInfoRequest();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static DeviceListInfoRequest getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public  static final class DeviceListInfoResponse extends
    ...
    public static DeviceListInfoResponse parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    ...
    public static DeviceListInfoResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static DeviceListInfoResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, input);
    }
    ...
    public static DeviceListInfoResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static DeviceListInfoResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
    ...
    public static Builder newBuilder(DeviceListInfoResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends
        ...
        DeviceListInfoResponseOrBuilder {
      // Construct using com.windchat.proto.server.ApiDeviceListProto.DeviceListInfoResponse.newBuilder()
      private Builder() {
        super(DEFAULT_INSTANCE);
      }
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new DeviceListInfoResponse();
        }
        case IS_INITIALIZED: {
          return DEFAULT_INSTANCE;
        }
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          DeviceListInfoResponse other = (DeviceListInfoResponse) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (DeviceListInfoResponse.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
    ...
    private static final DeviceListInfoResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DeviceListInfoResponse();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static DeviceListInfoResponse getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
